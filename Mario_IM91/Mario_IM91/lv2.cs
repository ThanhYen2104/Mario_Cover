...
namespace Mario_IM91
{
    public partial class lv2 : Form
    {
        ...
        private void lv2_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void lv2_Load(object sender, EventArgs e)
        {
            this.ControlBox = false;
            menu.formToanCuc.lvHienTai = "2";
        ...
        private void lv2_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void enemyTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (picNam1.Left < cot.Right || picNam1.Right > cot2.Left)
            {
                dx1 = -dx1;
            }
            picNam1.Left += dx1;
